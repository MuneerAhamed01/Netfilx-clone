...
import 'package:netflix/api/get_from_tmdb/get_from_tmdb.dart';
...
class ListOfImages extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        HeadingCategories(
            text: title, fontsize: 28.sp, padding: EdgeInsets.only(left: 4.w)),
        LimitedBox(
          maxHeight: 200,
          child: FutureBuilder(
...
class ListOfImagesCount extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        HeadingCategories(
            text: title, fontsize: 24.sp, padding: EdgeInsets.only(left: 4.w)),
        LimitedBox(
          maxHeight: 200,
          child: FutureBuilder(
